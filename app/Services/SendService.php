...
final readonly class SendService
{
    ...
    {
        $from = Carbon::now()->startOfHour()->subHours($api->orders_from_hours)->format('Y-m-d H:i:s');
        $to = Carbon::now()->endOfHour()->subHours($api->orders_from_hours)->format('Y-m-d H:i:s');
