                        ...
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse: separate; border-radius: 15px; background-color: #244d8b; vertical-align: top;" width="100%" bgcolor="#244d8b" valign="top">
                            ...
                            <tr>
                                <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    <div style="font-family:DM Serif Display;font-size:40px;line-height:68px;text-align:center;color:#ffffff;">{{ $storeName }}</div>
                                </td>
                            </tr>
                            </tbody>
                        </table>
                            ...
                            <tr>
                                <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    <div style="font-family:Arial, sans-serif;font-size:16px;line-height:22px;text-align:left;color:#333333;">
                                        <p> Dziękujemy za zakupy w {{ $storeName }}
                                        </p>
                                        <p> Pragniemy poinformować że Twoje zamówienie o numerze {{ $orderNumber }} oczekuje na płatność. W celu sfinalizowania transakcji prosimy o dokończenie płatności pod linkiem <a href="{{ $url }}" target="_blank">Opłać zamówienie ({{ $summary }} zł)</a>
                                        </p>
                                    </div>
                                </td>
                            </tr>
                                ...
                                <td align="left" style="font-size:0px;padding:10px 25px;padding-top:10px;padding-bottom:0;word-break:break-word;">
                                    <div style="font-family:Arial, sans-serif;font-size:16px;line-height:22px;text-align:left;color:#333333;">
                                        <mj-column>
                                            ...
                                            <p style="text-align: center;"> Zamówienie numer {{ $order['code'] }} z dnia {{ date('d-m-Y', strtotime($order['created_at'])) }}
                                            </p> @if (isset($order['shippingMethod'])) <p style="text-align: center;"> Dostawa: {{ $order['shippingMethod']['name'] }} </p> @endif
                                        </mj-column>
                                    </div>
                                </td>
                            </tr>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                            ...
                            <tr>
                                <td align="right" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    <div style="font-family:Arial, sans-serif;font-size:14px;line-height:0px;text-align:right;color:#000000;">
                                        <p> Dziękujemy, {{ $storeName }}
                                        </p>
                                    </div>
                                </td>
                            </tr>
